...
Please refer to the section on [Measuring performance of classification and regression models](./measure-performance-regression-classification.md) to learn more about the evaluation metrics for different types of machine learning problems.
...
- [Visual interface for Azure Machine Learning service](https://azure.microsoft.com/blog/visual-interface-for-azure-machine-learning-service/)
